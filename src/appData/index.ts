...
export const serviceData = [
  {
    ...
    shortDescription: 'Criação de aplicações web dinâmicas e interativas utilizando JavaScript.',
  },
  {
    icon: ReactIcon,
  ...
  },
  {
    ...
    shortDescription: 'Criando aplicações React renderizadas no servidor com Next.js.',
  },
  {
    icon: TypescriptIcon,
